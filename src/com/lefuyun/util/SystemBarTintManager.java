...
public class SystemBarTintManager {
	...
	// *
	// * If the platform does not have soft navigation keys, is running Jelly
	// Bean
	...
	// *
	// * @param drawable The drawable to use as the background, or null to
	// remove it.
	// */
	...
	//
	// /**
	// * Apply the specified drawable or color resource to the system status
	// bar.
	// *
	// * @param res The identifier of the resource.
	// */
	...
	//
	// /**
	// * Class which describes system bar sizing and other characteristics for
	// the current
	...
	public static class SystemBarConfig {
		...
		// current
		// * device configuration? A navigation bar may appear on the right side
		// of
		// * the screen in certain configurations.
		// *
		// * @return True if navigation should appear at the bottom of the
		...
		//
		// /**
		// * Get the layout inset for any system UI that appears at the top of
		// the screen.
		// *
		...
		//
		// /**
		// * Get the layout inset for any system UI that appears at the bottom
		// of the screen.
		// *
		// * @return The layout inset (in pixels).
		// */
