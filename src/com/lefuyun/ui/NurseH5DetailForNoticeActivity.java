...
public class NurseH5DetailForNoticeActivity extends BaseActivity {
	...
	protected void initView() {
		...
		animation=AnimationUtils.loadAnimation(NurseH5DetailForNoticeActivity.this,R.anim.nn);
		eventBus=EventBus.getDefault();
		animView=(PeriscopeLayout) findViewById(R.id.tv_one);
	...
	private void initUrl(){
		if(pageType==1){
			...
			url=url+"?id="+importantMsg.getId()+"&uid="+SPUtils.get(getApplicationContext(), "uid",1l)+"&oid="+importantMsg.getOldPeopleIds();
			LogUtil.e("url", url);
		}
		LogUtil.i("tag_url", url);
	}
