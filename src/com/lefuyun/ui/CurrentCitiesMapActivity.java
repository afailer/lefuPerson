...
public class CurrentCitiesMapActivity extends BaseActivity {
	...
	protected void initData() {
		...
		mCurrentOrganization = (Organization) intent.getSerializableExtra("organization");
		double latitude = mCurrentOrganization.getLatitude();
		double longitude = mCurrentOrganization.getLongitude();
        ...
        setItemData(mCurrentOrganization);
	...
	*/  
	...
	public class DemoRoutePlanListener implements RoutePlanListener {
	    ...
	    public void onJumpToNavigator() {
	         ...
	         */
	        Intent intent = new Intent(CurrentCitiesMapActivity.this, SatnavActivity.class);
