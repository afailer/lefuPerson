...
package com.lefuyun.zxing.camera;
...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int offset = (screenResolution.x - width) / 2;
			framingRect = new Rect(offset, offset, offset + width,
					offset + width);
			TLog.log("Calculated framing rect: " + framingRect);
		}
		return framingRect;
	}
