...
import com.lefuyun.bean.BezierEvaluator;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.drawable.img_zan_anim);
        Drawable yellow = getResources().getDrawable(R.drawable.img_zan_anim);
        Drawable blue = getResources().getDrawable(R.drawable.img_zan_anim);
